...
{
    public class CreatecfreezesCustomerController : Controller
    {
        //
        // GET: /CreatecfreezesCustomer/
        ...
        public JsonResult GetClimtempCustomer(string Usrlogin, string company, string cusno, string iemno, string slmcod)
        {
            ...
            var command = new SqlCommand("P_Claim_temp_Customer", Connection);
