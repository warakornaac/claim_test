...
{
    public partial class frmReceiveproductRT : System.Web.UI.Page
    {
        protected ReportViewer ReportViewerRT = new ReportViewer();
        ...
        private void fnLoadReportResRt()
        {
           ...
           // Doc = "CMT19050064";
            ...
            {
                ReportViewerRT.ProcessingMode = ProcessingMode.Local;
                ReportViewerRT.LocalReport.ReportPath = Server.MapPath("~/Report/rptReceiveproductRT.rdlc");
            ...
            ReportViewerRT.LocalReport.DataSources.Clear();
            ReportViewerRT.LocalReport.DataSources.Add(datasource2);
            ...
            //Render the report
            renderedBytes = ReportViewerRT.LocalReport.Render(
            reportType,
            deviceInfo,
            out mimeType,
            out encoding,
            ...
            Response.AddHeader("content-disposition", "attachment; filename=rptReceiveproductRT-" + cmsib + "-" + Cus + "-" + slm + "." + fileNameExtension);

            Response.BinaryWrite(renderedBytes);


            // string path = (Environment.GetFolderPath(Environment.SpecialFolder.UserProfile)) + @"\Downloads\rptRequestClaim" + ".pdf";
            string path = (Environment.GetFolderPath(Environment.SpecialFolder.UserProfile)) + @"\Downloads\rptReceiveproductRT-" + cmsib + "-" + Cus + "-" + slm + ".pdf";
