...
namespace ClaimWap.Report
{
    ...
    {
        protected ReportViewer ReportViewer3 = new ReportViewer();
        ...
        private void fnLoadReportBoc()
        {
           ...
           // Doc = "CMT19050064";
            ...
            using (SqlConnection con = new SqlConnection(conString))
            {
                ...
                ReportViewer3.LocalReport.ReportPath = Server.MapPath("~/Report/rptSupplier.rdlc");
                ...
                SqlCommand cmd = new SqlCommand("P_Rpt_Supplier", con);
                ...
                while (dr.Read())
                {
                    noid = dr["CLM_NO_Supplier"].ToString();
            ...
            ReportViewer3.LocalReport.DataSources.Add(datasource2);
           ...
           "<DeviceInfo>" +
            ...
            //Render the report
            renderedBytes = ReportViewer3.LocalReport.Render(
            reportType,
            deviceInfo,
            out mimeType,
            out encoding,
            ...
            string path = (Environment.GetFolderPath(Environment.SpecialFolder.UserProfile)) + @"\Downloads\rptSupplier" + noid + ".pdf";
