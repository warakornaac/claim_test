...
namespace ClaimWap
{
    public partial class frmRequestClaimWH : System.Web.UI.Page
    {
        ...
        private void fnLoadReportBoc()
        {
            ...
            using (SqlConnection con = new SqlConnection(conString))
            {
                ...
                ReportViewer2.LocalReport.ReportPath = Server.MapPath("~/Report/rptRequestClaimWH.rdlc");
                con.Open();
                SqlDataAdapter sda1 = new SqlDataAdapter();


                SqlCommand cmd = new SqlCommand("P_GetReqClaimWH_ByDoc", con);
